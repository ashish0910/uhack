...
<body>
  <div class="jk-container">
    ...
    <div class="options">
    <a href="dashboard.php?emotion=Happy"> 
    <div class="option"><span class="option-text" style="z-index:2">Happy</span>
      ...
      <a href="dashboard.php?emotion=Disgust">
      <div class="option">
      ...
      <a href="dashboard.php?emotion=Angry">
      <div class="option">
      ...
      <a href="dashboard.php?emotion=Neutral">
      <div class="option">
      ...
      <a href="dashboard.php?emotion=Surprise">
      <div class="option">
      ...
      <a href="dashboard.php?emotion=Fear">
      <div class="option">
      ...
      <a href="dashboard.php?emotion=Sad">
      <div class="option">
        <span class="option-text" style="z-index:2">Sad</span>
        <img src="https://3.bp.blogspot.com/-DrJqKERcZBE/V0me8N3-cKI/AAAAAAAAJSg/S2akaVFb8_Avf4nsfFqFa1k54gTPM3y4wCLcB/s1600/sad-images-10.jpg" alt="" class="option-img">
      </div>
