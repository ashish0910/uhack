...
<body>
  ...
  <div class="form">
    ...
    <a href="dashboard.php?emotion=<?php echo $emotion ; ?>"><button class="submit-btn" id="capture">SUBMIT</button></a>
    <a href="dashboard.php?emotion=<?php echo $emotion ; ?>"><button class="submit-btn" id="capture">SKIP</button></a>
